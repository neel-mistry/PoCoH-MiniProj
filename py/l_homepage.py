...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, -229, 1020, 1284))
...
"border-radius: 0.5em;")
        ...
        self.label_53.setPixmap(QtGui.QPixmap("../images/remedies/5.jpeg"))
...
"border-radius: 0.5em;")
        ...
        self.label_56.setPixmap(QtGui.QPixmap("../images/remedies/6.jpeg"))
...
"border-radius: 0.5em;")
        ...
        self.label_50.setPixmap(QtGui.QPixmap("../images/remedies/4.jpeg"))
...
"border-radius: 1.5em;")
    ...
    def retranslateUi(self, l_homepage):
        ...
        self.label_32.setText(_translate("l_homepage", "POST COVID REHAB EXERCISES FOR GENERAL WELLBEING"))
        self.label_31.setText(_translate("l_homepage", "These exercises are helpful in maintaining general wellbeing.These exercises are recommended by WHO. "))
        self.url5.setText(_translate("l_homepage", "Click here to view the video"))
        self.label_34.setText(_translate("l_homepage", "Rehabilitation for COVID-19 Patients: Breathing Exercises"))
        self.label_35.setText(_translate("l_homepage", "Demonstration of different breathing exercises that can help in rehabilitation of COVID-19 patients"))
        ...
        self.label_22.setText(_translate("l_homepage", "How to Start a Workout Plan Post-COVID"))
        self.label_23.setText(_translate("l_homepage", "Tips on how to start a workout plan after recovering from COVID. But how much should you do when you\'re getting over COVID-19? "))
        self.url2.setText(_translate("l_homepage", "Click here to view the video"))
        self.label_25.setText(_translate("l_homepage", "Post Covid Recovery(4 Weeks Exercise Guide)."))
        self.label_26.setText(_translate("l_homepage", "Guideline on how you can get back into exercising after Covid-19, for those who have had mild to moderate symptoms."))
        self.url3.setText(_translate("l_homepage", "Click here to view the video"))
        self.label_28.setText(_translate("l_homepage", "Long COVID and using physical activity safely"))
        self.label_29.setText(_translate("l_homepage", "Early studies of physical activity in people suffering with Long-COVID.  "))
        ...
        self.label_55.setText(_translate("l_homepage", " Remedy for Dengue Fever"))
